...
/**
 * Menu class, which handles building the application interaction interface.
 */
public class Menu {
    ...
    /**
     * Menu constructor, that sets up all the prerequisite initialisations
     */
    public Menu() {
        // Menu container
        menu = new VBox();
    ...
    public void initSliders() {
        ...
        octavesSlider = new Slider(0, 6, 5);
        ...
        scaleSlider = new Slider(0, 40, 2.5);
    ...
    public void startLoading() {
        ...
        map.setEffect(Main.mainMenu.loadingEffect);
        disableMenuItems();
    }
    ...
    public HBox buildWindow() {
        ...
        generateAnimals.addEventHandler(MouseEvent.MOUSE_CLICKED, event -> {
            ...
            (new Thread(() -> {
                ...
                Platform.runLater(() -> {
                    ...
                    Main.mainMenu.showAnimalsCheck.setVisible(true);
                    Main.mainMenu.generateAnimals.setVisible(false);
                });
            })).start();
        });
        ...
        ObservableList<FastNoise.NoiseType> noiseTypes = FXCollections.observableArrayList(
                FastNoise.NoiseType.Perlin, FastNoise.NoiseType.Simplex, FastNoise.NoiseType.Cellular,
